...
public class QuestionString {
    ...
    private String style;//问题的种类：若为单选题则取值为1，若为多选题取值为2
    private String timestamp;
    public QuestionString(){}
    public QuestionString(String index,String text,String answer1,String answer2,String answer3,String answer4,String rightAnswer,String sign,String style){
        this.id=index;
        this.text=text;
        this.ans1=answer1;
        this.ans2=answer2;
